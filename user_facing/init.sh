...
#   make /etc/resource_pool
#        /etc/resource_pool/ansible
#        /etc/resource_pool/ansible/playbooks
#        /etc/resource_pool/ansible/pool_template
#        /etc/resource_pool/ansible/keys
...
#get pool_template from git repo, put in /etc/resource_pool/ansible/pool_template
