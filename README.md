...
- Must implement
    - auto-scaling: this is the primary motivation for the use-case
...
- Stretch goals
    - high-availability: build out resiliency with existing k8s deployment or in collaboration with `consul`
